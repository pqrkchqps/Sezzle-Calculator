...
class App extends React.Component {
    ...
    handleSubmit = (event) => {
      ...
      axios.get(`https://arcane-sierra-66995.herokuapp.com/calculate/${Op.value}/${X.value}/${Y.value}`).then(() => {
    ...
    updateCalculations = () => {
      axios.get(`https://arcane-sierra-66995.herokuapp.com/calculations`)
      .then(res => {
